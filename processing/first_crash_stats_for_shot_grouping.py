...
def generate_first_crash_time_stats_for_multiple_groups(shots_multi_group, group_names, printouts=True, plots=False):
    ...
    if plots:
        ...
        plt.title(r"Probability Density Function $f(t)$ of First Crash Occurance Over Time $t$")
        plt.xlabel(r"$t\;[ms]$")
        plt.ylabel(r"$f(t)\;[ms]^{-1}$")
